// sa4f.cpp : Defines the entry point for the console application.
//
...
v3f toxy(v3f vi, float wx, float wy, v3f view, v3f pos, v3f up, v3f strafe, float maxd, float mind)
{
	v3f pv[8];
	v3f vvvv[3][2][2];
